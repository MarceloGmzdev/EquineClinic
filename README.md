...
- **Marcelo da Silva**: Implementação da **Camada de Infraestrutura** (Adapters TypeORM, Banco de Dados SQLite) e **Camada de Apresentação** (Controllers, DTOs e Integração com Swagger/OpenAPI).
